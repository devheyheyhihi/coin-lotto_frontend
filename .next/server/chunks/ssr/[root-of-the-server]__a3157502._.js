...
function Home() {
    ...
    const checkOwner = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (currentAccount)=>{
        if (window.ethereum && currentAccount && isCorrectNetwork) {
            ...
            const contract = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].Contract(LOTTERY_CONTRACT_ADDRESS, lotteryABI, provider);
                        ...
                        if (Date.now() - startTime > animationDuration) {
                            ...
                            const closeRound = async ()=>{
                                ...
                                if (winnerLog) {
                                    ...
                                    addFrontendLog('WINNER', `🎉 Congratulations to the winner: ${lotteryStatus.winner}`);
                                }
    ...
    const handleParticipate = async ()=>{
        ...
        try {
            ...
            const lotteryContract = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].Contract(LOTTERY_CONTRACT_ADDRESS, lotteryABI, signer);
            const participationFee = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].parseUnits("0.01", 18);
            // Check USDT balance first
            const balance = await usdtContract.balanceOf(account);
            if (balance < participationFee) {
                throw new Error(`Insufficient USDT balance. You have ${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].formatUnits(balance, 18)} USDT, but need 0.01 USDT.`);
            }
            // Check allowance
            const allowance = await usdtContract.allowance(account, LOTTERY_CONTRACT_ADDRESS);
            console.log(`Current allowance: ${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].formatUnits(allowance, 18)} USDT`);
            if (allowance < participationFee) {
                console.log('Approving USDT...');
                const approveTx = await usdtContract.approve(LOTTERY_CONTRACT_ADDRESS, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].MaxUint256);
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        children: lotteryStatus?.status === 'OPEN' ? 'Participate (0.01 USDT)' : `Round is ${lotteryStatus?.status || 'Loading...'}`
                    }, void 0, false, {
                        fileName: "[project]/src/app/page.tsx",
                        lineNumber: 322,
                        columnNumber: 17
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a3157502._.js.map