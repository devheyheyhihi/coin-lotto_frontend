...
function AdminPage() {
    ...
    const [isOwner, setIsOwner] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false); // Note: Now checks ownership of ANY room.
    ...
    const checkIsOwner = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        if (window.ethereum && isCorrectNetwork && account) {
            try {
                ...
                const lotteryContract = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].Contract(rooms[0].contractAddress, lotteryABI, provider);
    ...
    const handleStartDrawAll = async ()=>{
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/start-draw-all`, {
                method: 'POST'
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__84684c04._.js.map