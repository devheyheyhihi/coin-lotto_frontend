...
function RoomPage() {
        ...
        "RoomPage.useEffect": ()=>{
            ...
            const interval = setInterval({
                "RoomPage.useEffect.interval": ()=>{
                    ...
                    setTimeLeft("".concat(String(hours).padStart(2, '0'), ":").concat(String(minutes).padStart(2, '0'), ":").concat(String(seconds).padStart(2, '0')));
                }
    ...
    const checkOwner = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "RoomPage.useCallback[checkOwner]": async (currentAccount)=>{
            if (window.ethereum && currentAccount && isCorrectNetwork && (roomConfig === null || roomConfig === void 0 ? void 0 : roomConfig.contractAddress)) {
                ...
                const contract = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].Contract(roomConfig.contractAddress, lotteryABI, provider);
                try {
    ...
    }["RoomPage.useCallback[checkOwner]"], [
        isCorrectNetwork,
        roomConfig
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
...
_s(RoomPage, "RRRCrQKtK8ZDwkMTRRpupPd3L4A=", false, function() {
    return [
...
//# sourceMappingURL=src_41cee9ce._.js.map