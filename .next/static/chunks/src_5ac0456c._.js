...
(()=>{
    const e = new Error("Cannot find module '../../../backend/smart-contract/artifacts/contracts/Vault.sol/Vault.json'");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MyPageModal.useEffect": ()=>{
            if (account && activeMainTab === 'wallet') {
                const fetchBalance = {
                    "MyPageModal.useEffect.fetchBalance": async ()=>{
                ...
                }["MyPageModal.useEffect.fetchBalance"];
                fetchBalance();
            }
        }
    }["MyPageModal.useEffect"], [
...
_s(MyPageModal, "rwQiDYw7o4lseElwl6x/r9wrrus=");
_c = MyPageModal;
...
//# sourceMappingURL=src_5ac0456c._.js.map