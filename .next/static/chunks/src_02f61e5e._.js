...
function RoomPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RoomPage.useEffect": ()=>{
            if (account) {
                const fetchBalance = {
                    "RoomPage.useEffect.fetchBalance": async ()=>{
                        try {
                            const response = await fetch("".concat(API_BASE_URL, "/balance/").concat(account));
                            if (response.ok) {
                                const data = await response.json();
                ...
                }["RoomPage.useEffect.fetchBalance"];
                fetchBalance();
            } else {
                setBalance(0);
            }
    ...
    const handleParticipate = async ()=>{
        ...
        setError(null);
        try {
            const response = await fetch("".concat(API_BASE_URL, "/participate/").concat(roomId), {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
            ...
            setError("Participation failed: ".concat(error.message));
        } finally{
            setIsProcessing(false);
        }
    };
...
_s(RoomPage, "cOn9UnAIwAHExQAQNdpnHa9ZQ+I=", false, function() {
    return [
...
//# sourceMappingURL=src_02f61e5e._.js.map